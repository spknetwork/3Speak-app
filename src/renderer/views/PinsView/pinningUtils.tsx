...
import Config from '../../../main/core/components/Config'
import { shell } from 'electron'

const Utils = require('../../../main/core/utils')
...
export const usePinningUtils = () => {
        ...
        content: (
          <div>
            <Form ref={ref}>
              ...
              <FormControl name="reflink" placeholder="hive:username:123permlink"></FormControl>
            </Form>
          </div>
        ),
        buttons: {
  ...
  const handleCase3 = async () => {
    ...
    await config.open()
    let ipfsPath = config.get('ipfsPath')
