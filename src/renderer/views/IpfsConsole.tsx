...
class IpfsStatsLive extends Component<any,any> {
            ...
            <tbody>
                <tr>
                    ...
                    <th>
                        ...
                        <Button style={{marginLeft: "5px"}} className="btn-sm" onClick={() => {shell.openPath(this.state.repo.path)}}>
                            Open
                        </Button>
                    </th>
                </tr>
...
class IpfsDebug extends Component<any,any> {
    editor: any;
    pid: any;
    constructor(props) {
        super(props);
