...
class watch extends React.Component<any,any> {
    ...
    async gearSelect(eventKey) {
        var ref = RefLink.parse(this.state.reflink) as any
        switch(eventKey) {
            case "mute_post": {
            ...
            case "mute_user": {
                await PromiseIpc.send("blocklist.add", `${ref.source.value}:${ref.root}` as any)
                break;
            }
        }
    }
    ...
    render() {
        ...
        return <div>
            ...
            {/* <Container fluid pb={0}> */}
                ...
                <Row>
                    <Col md={8}>
                        ...
                        <div className="single-video-title box mb-3 clearfix">
                            ...
                            <div className="float-right" style={{ textAlign: "right !important", float: "right !important", display: "inline-block !important" } as any}>
                                <span>
             ...
             <LoopCircleLoading/> 
             <div style={{textAlign: "center", margin: "auto", position: "absolute", left: "0px", right: "0px", top: "60%", bottom: "0px"}}>
