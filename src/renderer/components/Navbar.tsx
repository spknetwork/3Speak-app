        ...
        return (<Navbar bg="white" expand="lg" id="layoutNav" className="bg_white fixed-left">
            ...
            <Navbar.Collapse >
                <Nav className="mr-auto nav_dist">
                    {this.state.login && (
                        <NavDropdown id="nav-dropdown" title={<React.Fragment><div className="nav_icons"><VscKey size="21px"/></div><span>@{this.state.login}</span></React.Fragment>}>
                    ...
                    <NavDropdown id="nav-dropdown" title={<React.Fragment>
