...
class PostComment extends Component {
    ...
    get postTimeDistance() {
        return NormaliseTime(new Date() - new Date(this.state.commentInfo.creation), "ms")
    }
    get postTime() {
                ...
                <div className="panel ml-2 panel-default">
                    ...
                    <div className="panel-footer ml-0 ml-md-4">
                        ...
                        <ul class="list-inline list-inline-separate">
                            <li class="list-inline-item"><Vote reflink={this.props.reflink} /></li>
                            <li class="list-inline-item" style={{ cursor: "pointer" }} onClick={(() => {
                                this.setState({
